    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('context', ckeditor_uploader.fields.RichTextUploadingField(verbose_name='Контент')),
            ],
            options={
                'verbose_name': 'Статья',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('favorite_title', models.CharField(max_length=255, verbose_name='Загаловка')),
                ('favorite_slug', models.SlugField(verbose_name='Слаг')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Юзер')),
            ],
            options={
